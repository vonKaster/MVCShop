      ...
      <div>
        ...
        >
          ...
          <v-card-subtitle
            ...
            style="color: #ffffff"
            >{{ compra.totalProducts }} Productos - Precio total {{ compra.totalPrice }}</v-card-subtitle
          >
          ...
          <v-list>
            <v-list-item-group>
              ...
              >
                <v-list-item-content>
                  <div class="d-flex">
                    <v-img class="mr-4" max-width="48px" :src="producto.imagen"></v-img>
...
export default {
  ...
  computed:{
    getSales() {
      return products.state.getSales;
    },
  },
